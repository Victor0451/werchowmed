...
import FormLiquidacion from "../../components/servicios/FormLiquidacion";
import TablaLiquidacion from "../../components/servicios/TablaLiquidacion";
import ExportarPadron from "../../components/servicios/ExportarPadron";
...
const Liquidacion = () => {
  ...
  const calcularLiquidacion = async () => {
    ...
    if (medicoRef.current.value === "no") {
      ...
      await axios
        .get(`${ip}api/sgi/servicios/liquidacion`, {
          params: {
        ...
        .catch((error) => {
          ...
          toastr.error(
            "Ocurrio un error al generar la liquidacion",
            "ATENCION"
          );
        });
    }
          ...
          <div className=" container list mt-4 border border-dark p-4">
            ...
            <div className="row border border-dark p-4 mt-4">
              <div className="col-md-12 d-flex justify-content-center">
                <button className=" btn btn-primary mr-1" onClick={imprimir}>
                  Imprimir
                </button>
