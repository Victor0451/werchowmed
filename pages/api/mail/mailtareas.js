...
export default async function sendMail(req, res) {
  const mailData = {
    ...
    subject: `Notificacion de tarea: Centro Medico Otero - WERCHOW Servicios Medicos`,
    ...
    <u>
    ${req.body.ft} de Tarea en Centro Medico Otero
    </u>
    ...
    <p><strong><u>¿Todo el dia?</strong></u>: ${
      req.body.allDay === 1 ? "Si" : req.body.allDay === 0 ? "No" : null
    }</p> 
    ...
    <p>Email enviado desde: WERCHOW Servicios Medicos - http://sgi.werchow.com
     </p>
