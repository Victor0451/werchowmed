  ...
  return (
    <ul className="navbar-nav me-lg-auto">
      ...
      <li className="nav-item dropdown d-lg-none">
        ...
        <ul className="dropdown-menu">
          <li><a className="dropdown-item" href="/servicios/caja"><i className="fa fa-money-bill me-2"></i> Generar Caja</a></li>
          <li><a className="dropdown-item" href="/calendario/calendario"><i className="fa fa-tasks me-2"></i> Registrar Tareas</a></li>
          {userData.perfil === 1 || userData.perfil === 3 ? (
            <li><a className="dropdown-item" href="/servicios/administracion"><i className="fa fa-user-shield me-2"></i> Administración</a></li>
          ) : null}
        </ul>
      </li>
    </ul>
