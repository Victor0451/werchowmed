        ...
        <div className="card">
          <div className="card-header" id="headingOne">
            <h2 className="mb-0">
              ...
              >
                <strong>Control de Ordenes Por Sucursal</strong>
              </button>
            </h2>
          </div>
          ...
          >
            <div className="card-body">
              <div className="alert alert-info border border-dark text-center text-uppercase mt-4 mb-4">
                Control de ordenes emitidas por sucursal y rango de fechas.
              </div>
        ...
        {/* <div className="card">
          <div className="card-header" id="headingTwo">
            <h2 className="mb-0">
              ...
              >
                <strong>Control de Consultas Por Medico</strong>
              </button>
            </h2>
          </div>
          <div
          ...
          >
            <div className="card-body">
              <div className="alert alert-info border border-dark text-center text-uppercase mt-4 mb-4">
                Selecciona un prestador medico y un rango de fechas para
                visualizar las consultas y practicas emitidas en el mismo.
              </div>
