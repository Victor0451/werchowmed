    ...
    <div className="container border border-dark list p-4 mt-4">
      ...
      ficha[0].GRUPO === 8500 ? (
        ...
        >
          ...
          <h5>El afiliado esta en estado de morosidad!!!.</h5>
        </div>
      ) : ficha[0].GRUPO === 66 || ficha[0].GRUPO === 55 ? (
        <div className="alert alert-info border border-dark text-center text-uppercase">
          El afiliado es un estudiante de policia o penintenciaria, el sistema
          verificara si es su primer orden y le bonificara al 100%
        </div>
      ) : (
        <div className="alert alert-info border border-dark text-center text-uppercase">
          El afiliado no es moroso, pero igual verifica si esta al dia con sus
          pagos!
        </div>
      )}
      ...
      <div className="alert alert-info border border-dark text-center text-uppercase">
        ...
        MES Y POR GRUPO FAMILIAR. EL SISTEMA LA COMPUTA Y MUESTRA EL VALOR EN
